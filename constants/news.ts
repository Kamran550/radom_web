...
export const news: NewsItem[] = [
  {
    id: "1",
    title: "RADOM Welcomes New International Students",
    slug: "radom-welcomes-new-international-students",
    category: "university",
    date: "2024-12-15",
    excerpt:
    ...
    content: `
      ...
      <p>We're excited to see the contributions these new students will make to our university community and wish them success in their academic journey at RADOM.</p>
    `,
    author: "Admissions Office",
    featured: true,
    readTime: 3,
    tags: ["International Students", "Admissions", "University"],
    image: "/images/radom-hero-campus.jpg",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    date: "2024-12-05",
    excerpt:
      "RADOM celebrates the opening of a state-of-the-art research laboratory dedicated to science and management studies.",
    content: `
  ...
  {
    id: "9",
    title: "Sustainability Initiatives at RADOM",
    slug: "sustainability-initiatives-at-radom",
    category: "university",
    date: "2024-11-10",
    excerpt:
  ...
  {
    id: "11",
    title: "New Faculty Members Join RADOM",
    slug: "new-faculty-members-join-radom",
    category: "academic",
    date: "2024-10-30",
    excerpt:
      "We welcome distinguished faculty members who bring expertise and innovation to our academic programs.",
    content: `
      <p>We're pleased to welcome several distinguished faculty members to RADOM, bringing valuable expertise and fresh perspectives to our academic programs.</p>
